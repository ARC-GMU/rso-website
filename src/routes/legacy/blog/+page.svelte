                ...
                {#each data.posts as post}
                    <div class="border border-black bg-[#f8f8f8] flex flex-col h-full hover:bg-[#eee] transition-colors">
                        {#if post.coverImageUrl}
                            <a href={`/legacy/blog/${post.slug}`} class="w-full h-48 overflow-hidden block border-b border-black">
                                <img
                        ...
                        <div class="p-4 flex flex-col flex-1">
                            <h3 class="m-0 text-xl font-bold mb-2">
                                <a href={`/legacy/blog/${post.slug}`} class="text-black no-underline hover:underline">
                                    {post.title}
                                </a>
                            </h3>
                            ...
                            <a href={`/legacy/blog/${post.slug}`} class="mt-auto block">
